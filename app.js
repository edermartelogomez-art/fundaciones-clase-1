...
let anim;
animateBtn.onclick=()=>{
  if(anim){anim.cancel();anim=null;animateBtn.textContent="▶ Animar carga";return}
  animateBtn.textContent="■ Detener";
  anim=loadPulse.animate([{transform:"translateX(-50%) translateY(0)",opacity:.45},{transform:"translateX(-50%) translateY(130px)",opacity:1},{transform:"translateX(-50%) translateY(0)",opacity:.45}],{duration:1100,iterations:Infinity});
};
